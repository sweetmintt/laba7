...
// Функция evaluate принимает один аргумент -- строку с арифметическим выражением, записанным в обратной польской нотации. 
// Возвращаемое значение -- результат вычисления выражения. Выражение может включать действительные числа и операторы +, -, *, /.
